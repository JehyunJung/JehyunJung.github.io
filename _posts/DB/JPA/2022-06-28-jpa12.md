...
스프링 프레임워크에서 JPA를 사용하려면 LocalContainerEntityManagerFactoryBean을 Spring Bean으로 등록해야한다. Spring-ORM 라이브러리 등록시, LocalContainerEntityManagerFactoryBean 클래스가 제공된다.
